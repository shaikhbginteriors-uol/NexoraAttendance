      ...
      <main className="relative -mt-10 sm:-mt-12 pb-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <footer className="mt-10 text-center text-xs text-muted-foreground">
            <p>
              © {new Date().getFullYear()} NEXORA Montessori & Modern Skills Council. All rights
              reserved.
            </p>
            <p className="mt-1">Powered by the NEXORA Attendance Portal.</p>
          </footer>
        </div>
      </main>
    </div>
  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-card p-4 hover:border-brand-teal/40 transition">
      <div className="flex items-start gap-3">
        <div className="rounded-xl bg-brand-teal-light p-2 text-brand-teal">{icon}</div>
        <div>
